...
//     case RELOP_LTU:  return (uint32_t)src1<(uint32_t)src2;  
//     case RELOP_LEU:  return (uint32_t)src1<=(uint32_t)src2;
//     case RELOP_GTU:  return (uint32_t)src1>(uint32_t)src2;
//     case RELOP_GEU:  return (uint32_t)src1>=(uint32_t)src2;
//     default:assert(0);
//     }
//     assert(0);
//     return false;
